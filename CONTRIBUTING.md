# Contributing to Medmark

I would love for you to contribute to Medmark and help make it even better than it is today!
...
```shell
git clone https://github.com/<github username>/medmark.git
```

3. Set the original repo as the upstream remote.

```shell
git remote add upstream https://github.com/brionmario/medmark.git
```
